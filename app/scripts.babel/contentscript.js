...
function init() {
  ...
  $input.textcomplete([{
    ...
    template: function (emoji) {
      const service = (hostname === 'twitter.com' || hostname === 'tweetdeck.twitter.com') && emoji && emoji.has_img_twitter;
...
// listen for changes to the DOM to reinitialize emoji suggestions
